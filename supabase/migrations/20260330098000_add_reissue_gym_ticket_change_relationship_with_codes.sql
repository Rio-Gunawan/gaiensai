...
ALTER FUNCTION public.reissue_gym_ticket_change_relationship_with_codes(
  uuid, text, smallint, smallint, smallint, smallint, integer, text[], text[]
) OWNER TO postgres;

REVOKE ALL ON FUNCTION public.reissue_gym_ticket_change_relationship_with_codes(
  uuid, text, smallint, smallint, smallint, smallint, integer, text[], text[]
) FROM PUBLIC;
...
GRANT EXECUTE ON FUNCTION public.reissue_gym_ticket_change_relationship_with_codes(
  uuid, text, smallint, smallint, smallint, smallint, integer, text[], text[]
) TO service_role;
