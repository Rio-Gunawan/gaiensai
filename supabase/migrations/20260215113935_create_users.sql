...
CREATE UNIQUE INDEX users_affiliation_key ON public.users USING btree (affiliation);

alter table "public"."users" add constraint "users_affiliation_key" UNIQUE using index "users_affiliation_key";
