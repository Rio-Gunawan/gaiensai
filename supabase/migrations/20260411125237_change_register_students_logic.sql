...
CREATE OR REPLACE FUNCTION public.register_student(student_name text, grade_no integer, class_no integer, student_no integer, teacher_name_input text, clubs text[])
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
...
begin
  ...
  values (
    ...
    student_name,
    (grade_no * 10000 + class_no * 100 + student_no),
    'student',
    clubs
  );
end;$function$
