...
このソースコードは、MIT ライセンスのもとで公開しています。どなたでも自由に使用して構いません。

ただし、/public/のfavicon.ico、favicon.svg、og.jpg、*.pngおよび/src/assets/decor/および/src/assets/hero/を除く/src/assets/以下のすべてのファイルは、MITライセンスの適用外で、各画像の著作権者の許諾なしに使用することは固く禁じます。詳細は該当するフォルダ内のLICENSE.txtを参照してください。
